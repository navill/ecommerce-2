...
# pre_save를 이용해 cart 인스턴스가 저장되기 전,
# 아이템의 총 합 가격을 Cart 인스턴스에 저장 -> 이후 save() 처리
...
# cart_item_pre_save_receiver()을 CartItem에 연결
# -> CartItem.save() 실행되기 전, cart_item_pre_save_receiver() 실행
